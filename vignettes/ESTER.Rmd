...
Then, one can study the distribution of evidence ratios using the `distER` function.

```{r echo = TRUE, eval = TRUE, fig.align = "center", fig.height = 6, fig.width = 9}
...
```{r echo = TRUE, eval = TRUE, fig.align = "center", fig.height = 6, fig.width = 6, warning = FALSE, results = "hide"}
data(mtcars)
