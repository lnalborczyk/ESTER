...
ER <- simER(cohensd = 0.3, n = 100, nmin = 20, plot = TRUE)
...
ER <- distER(cohensd = 0.3, n = 100, nmin = 20, nSims = 100)
...
Studying the behavior of bootstrapped samples.
...
mod1 <- lm(mpg ~ cyl, mtcars)
mod2 <- lm(mpg ~ cyl * disp, mtcars)
#seqERboot(mod1, mod2, order_nb = 2, nmin = 10, replace = TRUE) %>% plot
